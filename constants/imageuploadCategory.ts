export const imageUploadCategory = {
  ...
  SERVICES_PRE_WEDDING: "services-pre-wedding",
  SERVICES_PERSONAL_SHOOT: "services-personal-shoot",
  SERVICES_MATERNITY: "services-maternity",
  ABOUT_PERSONAL_PHOTO: "about-personal-photo",
};
